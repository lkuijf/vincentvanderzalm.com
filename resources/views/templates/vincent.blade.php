...
<?php
$path = '/';
$currentURLParsed = parse_url(url()->current());
if(isset($currentURLParsed['path'])) $path = $currentURLParsed['path'];
// dd($path);
if($path == '/') {
?>
...
<div class="uk-section-default uk-light uk-cover-container uk-section uk-padding-remove-top uk-flex uk-flex-middle" uk-height-viewport="offset-top: true; offset-bottom: 20;" style="min-height: calc((100vh - 70px) - 20vh);">
    ...
    <video src="wp-content/uploads/sites/19/2021/03/VincentVanDerZalm-video-Livestreams.mp4" loop="" autoplay="" muted="" playsinline="" uk-cover="" class="uk-cover" style="height: 1071px; width: 1904px;"></video>
...
<h1 class="uk-h1 uk-heading-bullet">        Livestreams    </h1>
<h1 class="uk-h4 uk-width-xlarge">        Kook tegelijk met je collega’s live mee met sterrenchef Vincent van der Zalm.    </h1>
...
if($path == '/pop-up-koken') {
?>
<div class="uk-section-default uk-light uk-cover-container uk-section uk-padding-remove-top uk-flex uk-flex-middle" uk-height-viewport="offset-top: true; offset-bottom: 20;" style="min-height: calc((100vh - 70px) - 20vh);">
    
    <video src="wp-content/uploads/sites/19/2021/03/VincentVanDerZalm-video-Pop-up-koken.mp4" loop="" autoplay="" muted="" playsinline="" uk-cover="" class="uk-cover" style="height: 1071px; width: 1904px;"></video>
...
<div class="uk-section-default uk-light uk-cover-container uk-section uk-padding-remove-top uk-flex uk-flex-middle" uk-height-viewport="offset-top: true; offset-bottom: 20;" style="min-height: calc((100vh - 70px) - 20vh);">
    ...
    <video src="wp-content/uploads/sites/19/2021/03/VincentVanDerZalm-video-Thuiskoken.mp4" loop="" autoplay="" muted="" playsinline="" uk-cover="" class="uk-cover" style="height: 1071px; width: 1904px;"></video>
...
<h1 class="uk-h1 uk-heading-bullet">        Thuisdiners    </h1>
<h1 class="uk-h4 uk-width-xlarge">        Vincent neemt met liefde uw plaats in de keuken in en tovert een smakelijk diner op tafel.    </h1>
...
<div class="uk-section-default uk-light">
    <div data-src="/wp-content/themes/yootheme/cache/VincentVanDerZalm-header-amuse-op-steen-mono-7bec7c7b.webp" data-srcset="https://vincentvanderzalm.com/wp-admin/admin-ajax.php?action=kernel&amp;p=image&amp;src=WyJ3cC1jb250ZW50XC91cGxvYWRzXC9zaXRlc1wvMTlcLzIwMjFcLzAzXC9WaW5jZW50VmFuRGVyWmFsbS1oZWFkZXItYW11c2Utb3Atc3RlZW4tbW9uby5qcGciLFtbImRvUmVzaXplIixbNzY4LDQzMiw3NjgsNDMyXV0sWyJkb0Nyb3AiLFs3NjgsNDMyLDAsMF1dXV0%3D&amp;hash=f971229d2db3777960c99a495219f93f 768w, https://vincentvanderzalm.com/wp-admin/admin-ajax.php?action=kernel&amp;p=image&amp;src=WyJ3cC1jb250ZW50XC91cGxvYWRzXC9zaXRlc1wvMTlcLzIwMjFcLzAzXC9WaW5jZW50VmFuRGVyWmFsbS1oZWFkZXItYW11c2Utb3Atc3RlZW4tbW9uby5qcGciLFtbImRvUmVzaXplIixbMTAyNCw1NzYsMTAyNCw1NzZdXSxbImRvQ3JvcCIsWzEwMjQsNTc2LDAsMF1dXV0%3D&amp;hash=c38aed28ebfa6315be05c57758a574cc 1024w, https://vincentvanderzalm.com/wp-admin/admin-ajax.php?action=kernel&amp;p=image&amp;src=WyJ3cC1jb250ZW50XC91cGxvYWRzXC9zaXRlc1wvMTlcLzIwMjFcLzAzXC9WaW5jZW50VmFuRGVyWmFsbS1oZWFkZXItYW11c2Utb3Atc3RlZW4tbW9uby5qcGciLFtbImRvUmVzaXplIixbMTM2NSw3NjgsMTM2NSw3NjhdXSxbImRvQ3JvcCIsWzEzNjYsNzY4LDAsMF1dXV0%3D&amp;hash=8bfd9d81f0f3b394290e56e4ed4c645d 1366w, https://vincentvanderzalm.com/wp-admin/admin-ajax.php?action=kernel&amp;p=image&amp;src=WyJ3cC1jb250ZW50XC91cGxvYWRzXC9zaXRlc1wvMTlcLzIwMjFcLzAzXC9WaW5jZW50VmFuRGVyWmFsbS1oZWFkZXItYW11c2Utb3Atc3RlZW4tbW9uby5qcGciLFtbImRvUmVzaXplIixbMTYwMCw5MDAsMTYwMCw5MDBdXSxbImRvQ3JvcCIsWzE2MDAsOTAwLDAsMF1dXV0%3D&amp;hash=dceeeb4aba5578a0e807314eb4419acc 1600w, /wp-content/themes/yootheme/cache/VincentVanDerZalm-header-amuse-op-steen-mono-7bec7c7b.webp 1920w" data-sizes="(max-aspect-ratio: 1920/1080) 178vh" uk-img="" class="uk-background-norepeat uk-background-cover uk-background-center-center uk-section uk-padding-remove-top uk-flex uk-flex-middle" uk-height-viewport="offset-top: true; offset-bottom: 20;" style="background-image: url(&quot;https://vincentvanderzalm.com/wp-content/themes/yootheme/cache/VincentVanDerZalm-header-amuse-op-steen-mono-7bec7c7b.webp&quot;); min-height: calc((100vh - 70px) - 20vh);">    
...
{{-- <h1 class="uk-h1 uk-heading-bullet">        Welkom    </h1>
<div class="uk-panel uk-margin">
    <p>Na ruim 17 jaar in verschillende sterrenkeukens te hebben gewerkt, is het nu tijd voor grenzeloze creativiteit. Zonder vaste locatie gaat Chefkok Vincent van der Zalm de uitdaging aan om op bijzondere plekken te koken.</p>
    <p>Grenzeloos betekent niet alleen dat er gekookt wordt op verrassende en wisselende locaties, maar biedt ook een nieuw perspectief op inspiratie.</p>
    <p>Vincent grijpt deze kans aan om nieuwe samenwerkingen uit te rollen en om nieuwe smaken, nieuwe producten en nieuwe smaakcombinaties te ontdekken.</p>
</div> --}}
